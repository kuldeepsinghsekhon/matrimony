...
<!-- ============================  Navigation End ============================ -->
 <%@include file="view_profile_body.jsp" %> 
 <%@include file="footer.jsp" %> 
  
   <!-- FlexSlider -->
<script defer src="<%=getServletContext().getContextPath() %>/js/jquery.flexslider.js"></script>
<link rel="stylesheet" href="<%=getServletContext().getContextPath() %>/css/flexslider.css" type="text/css" media="screen" />
<script>
